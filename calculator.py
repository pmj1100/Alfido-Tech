...
display_text=Entry(main, font=("arial", 20, "bold"), textvariable=input_value, bd=30, insertwidth=4, bg="green", justify=RIGHT)
...
btn_5=Button(main, padx=16, bd=8, fg="black", font=("arial", 28, "bold"), text="5", command=lambda:buttonClick(5))
